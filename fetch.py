#!/usr/bin/env python3
"""
Recupero codici sconto Farfetch da shopilo.it
Sursa: https://shopilo.it/negozi/farfetch.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/farfetch.com"
STORE_NAME = "Farfetch"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Farfetch da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-farfetch)"
    }
    try:
